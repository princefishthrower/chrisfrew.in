...
export function Book() {
    return (
        <>
            ...
            <p>
                In the <i>Full Stack SaaS Product Cookbook</i>, you'll learn in
                step-by-step tutorials how to do the following:
            </p>
            <ul>
                <li>
                    Frontend: how to build an amazing Gatsby site using
                    TypeScript and React, and use Netlify as your frontend CI /
                    CD framework.
                </li>
                <li>
                    Backend: how to use FaunaDB for user data storage and your
                ...
                <li>
                    How to implement Stripe, Gumroad, and PayPal as your three
            ...
            <p>
                ...
                <i>identical</i> to the process I used on{" "}
            ...
            <h2 style={{ textAlign: "center" }}>
                <Sparkles>Book Coming Soon</Sparkles>
            </h2>
        </>
    )
}
