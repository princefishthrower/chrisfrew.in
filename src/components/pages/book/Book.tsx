        ...
        <>
            ...
            <p>In the <i>Full Stack SaaS Product Cookbook</i>, you'll learn in step-by-step tutorials how to do the following:</p>
                <ul>
                    ...
                    <li>Backend: how to use FaunaDB for user data storage and your own .NET 5.0 API running on an Ubuntu 20.04 Digital Ocean Droplet with PostgreSQL 13 for anything more advanced that you may need, and use BitBucket Pipelines as your backend CI / CD framework.</li> 
