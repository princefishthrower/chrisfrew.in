...
export function Courses () {
  ...
  return (
    <>
      <h1 className="cooper big">{colorizeStringBySeparator(themeBodyClass, "Full Stack Courses.","")}</h1>
      ...
      <CourseTiles/>
      <p><i>While selling these Full Stack Courses is a primary source of my income and enables me make <b> even more</b> Full Stack Courses, I understand if you can't afford a course at any time. Reach out to me at frewin.christopher@gmail.com or hi@fullstackcraft.com and I can grant you access to the full course for free.</i></p>
      <p><i>Additionally, please don't hesitate to get in touch if you have a request or idea for a new Full Stack Course in any language or framework - I'll see what I can do.</i></p>
    </>
  );
}
