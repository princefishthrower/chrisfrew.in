      ...
      <div>
        ...
        <footer>
          <h5>
            ...
            Colors inspired by the Monokai color scheme (I will always <Emoji text=":two_hearts:"/>{'\u00A0'}{'\u00A0'}Sublime Text <Emoji text=":smile:" /> )<br/>
            Served on a DigitalOcean Droplet with Node.js & express.<br/>
            Copy icon in code copypastas from flaticon.<br/>
            Really like the blog? You can support me:<br/><br/>
    ...
    this.space.add( {
      start: (bound, space) => {
        ...
        for (let i=0, len=pts.length; i<len; i++) {
          let p = new Particle( pts[i] ).size( 10 );
      ...
      animate: (time, ftime) => {
        world.drawParticles( (p, i) => {
          let color = ["#F92672", "#66D9EF", "#A6E22E"][i%3];
