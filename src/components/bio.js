...
const Bio = () => {
  ...
  return (
    ...
    <a href="https://rœst.com" target="_blank" rel="noopener noreferrer">rœst.com</a> / <a href="https://rœst.com" target="_blank" rel="noopener noreferrer">rœst.coffee</a> (Solo)<br/>
