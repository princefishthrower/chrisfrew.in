---
title: Introducing react-use-please-stay
description: Animate the document title and favicon in your React projects with ease using this powerful hook!
date: "2021-04-26"
draft: false
...
Again, the package is [completely open source](https://github.com/princefishthrower/react-use-please-stay), where you'll find the most up-to-date code, but if you're interested into peering into how the hook works right away, here it is:
