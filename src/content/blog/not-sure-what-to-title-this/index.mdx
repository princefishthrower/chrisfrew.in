...
- try to publish a full stack beta example of [Kurynt](https://kurrent.com), but this involves building a MVP backend in a language and framework I'm not very experienced in, a pipedream if I want to try and finish that tonight I suppose
...
Yet I think a straightforward answer or guide isn't so simple to find. I'm always torn between two ends which have been fantastically memified in our current binary times: I'm definitely not of the YOLO / nowork / do the bare minimum camp, as then you as a human are providing literally no value to anybody else; however as of late I've also not in the camp of the enternal "mindset into grindset" that you should always be working. Who is going to know or care you learned one more language or technique over the course of your life? Probably no one.
...
**- hiring / recruiting culture** As us developers know, the classic "we want 10 years of experience" for a tool or language that has been in existance for only 5 years, or "we need people who have been using tool X every single day for the past Y years". (These are both real examples, the first one is anyway quite famous and the second one I really did from a recruiter). I mean give me a break, we don't ask our accountants that you've been adding up certain amounts of numbers for X number of years. This is also simple and utter bullshit.

**- underestimation, under-valuation, and resource-only culture** "Ah, it's just a dev, he writes some symbols on a screen and can be quickly replaced!" This is total bullshit. We're humans too, and not just robots to do a manager's bidding. We're the ones making tens (if not sometimes hundreds!) of minute decisions a day that will DIRECTLY affect your business and product (and in some cases directly _are_ your product!) I've seen companies grow and die because absolutely 0 care or consideration was placed in the developers - here in Europe, some companies literally treat their entire IT as an an opportunity to be outsourced and given to the lowest bidder. This is a recipe for absolute disaster. Granted, I think this piece of the culture is _finally_ starting to change, but its an extremely slow change. (It's like, dude, your company IS fucking tech, you'd better put ALL your money IN the tech, not try and see how much of a technological mess you can accomplish at the lowest price tag possible!)

<hr/>

A lot of these points are so complex and have such a variety origins I could probably write a separate blog post for each of them - but maybe that's for another time.
...
Whew, I feel much better writing that all out (at least in the immediate sense - I don't think it has changed my general disposition and the fact of the points I've listed above). Hopefully this rant / post helped you burn off some steam too.

I think I'm off to go try out my first custom gRPC contract with [Kurynt](https://kurrent.com) now 😄. It's this fun feeling of the first time learning something new, or trial and error exploration that every dev should try to hold on to and never forget - remember its this same spark of excitement that perhaps got us started with software in the first place! 
