...
<AudioPlayer audioSrc="/audio/want-to-build-this-blog-now-you-can/audio.mp3"/>

If you've been wondering about how the internals of my blog are built and developed, you can now learn it from me, step by step, from [my very first course on Skillshare](https://skl.sh/2qGtFlG), titled <Sparkles>Build Your Personal Blog Website with GatsbyJS!</Sparkles>

(Not to mention the source code of this site itself is all public [here on GitHub](https://github.com/frewinchristopher/chrisfrew.in)). 

There are a variety of platforms offering this course, including Skillshare and Udemy:

<LinkPreview url="https://skl.sh/2qGtFlG" fallbackTitle="Skillshare"/>

<LinkPreview url="https://www.udemy.com/course/blog-with-gatsby-js" fallbackTitle="Udemy"/>

If you want to get started with just a preview of the course, check that out here:

<LinkPreview url="https://www.youtube.com/watch?v=z0omDiN1XfY&list=PLOX_mQri1cCkC1FvLGjIH_9Sx0sZeTEVq" fallbackTitle="Youtube (First 3 Lessons)"/>
