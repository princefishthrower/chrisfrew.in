...
When I write in LaTex, I use VS Code with the [LaTeX Workshop Extension](https://marketplace.visualstudio.com/items?itemName=James-Yu.latex-workshop). This extension creates a new pdf every time you save your .tex file. I then only have to run the custom bash script to combine the title page with the rest of the book to have a shippable book each time.
...
This was probably too ambitious for my very first book, so I'm stepping back and will be publishing a much shorter and more focused book by this summer — stay tuned.
