...
In the end, my girlfriend was actually one of the first players to go out, while my brother lasted as 2nd place in the game (I actually ended up winning due to massive luck with the magenta properties - Virginia, States, and St. Charles Place).
...
I calculated and plotted this for 1,2, and 3 'lands' on a property:

![Chart of ROI values per rent-style property](chart.svg)

(Sorry for the non-interactive .svg, Gatsby 2.0 currently has no way of including bar charts easily - or at least I spend a few hours trying t o. Though I may consider reopening [this](https://github.com/knsv/mermaid/issues/22) pull request on mermaid<sup>[2](#footnote-2)</sup> and doing it myself.)
...
This analysis of the expected return on a property shows us that the light blue properties are the best investment in terms of expected return. However, it's not yet a complete picture of the game. We need to consider locations on the board to complete our analysis.

## Spatial Considerations

First, a crucial takeway from the monopoly board layout is that a large sink of player location on the board is the jail. All Chance and Community Chest spaces have a small chance of sending you there, and then of course the Go To Jail space will send you there. So let's look at the roll probabilities from the jail space to the following 2-12 spaces, at least in terms of rentable properties.
...
Yes, landing on Community Chest from jail is actually the most likely single roll of 7 at 16.667% from a two dice, but the combined probability of Tennessee, St. James, and New York Avenue with rolls of 6, 8, and 9 at 13.889%, 13.889%, and 11.111%, respectively, is an overwhelming net of 38.889% chance of a landing on an orange property from a single role from jail. The possibility of landing on a purple by rolling a 3 or 4 at States and Virginia is 5.556% + 8.333% = 13.889%, and for the slim chance of a roll of 11 to Kentucky, only 5.556%.
...
- Seek first the orange properties (as the nearly unanimously accepted best property by more people other than just me) 
- Seek second the light blues (from a pure return on investment perspective) 
- Seek then any of the magenta, yellow, or red property sets (in that order, based on nothing more than the ROI calculations mixed with my weak probability intuition)
...
- While I think it's okay to try to work with the greens or blues later on in the game, don't bother with them in the 'early game'<sup>[3](#footnote-3)</sup>. If landing on a green or blue early in the game, I often let them be auctioned off by other players. Many a time I see players nearly bankrupting themselves in the early game to buy and build houses on these properties, only to get knocked off by an albiet more modest, still significant in size rent from a light blue, magenta, orange, red, or yellow property with some houses.

### Detailed Ranking

So, a fair rank for the properties is as follows:

1. Orange properties
2. Light blue properties
3. Magenta properties (or light purple / pink if you prefer, AKA the ones next to the orange properties)
4. Yellow properties
5. Red properties
6. Blue properties
7. Green properties
8. Brown properties (dark purple if you prefer?)

I ranked the greens above the browns because there are three of them, and the hotel prices that come with the browns at $250 and $450 just usually aren't enough to do much damage late game<sup>[4](#footnote-4)</sup>. The blues could perhaps be a bit higher, maybe above the reds or the yellows in terms of rank, but again, there are only two blue properties, and they are after that jail 'sink' space. It would take a full board analysis to truly claim where they sit.

### Simple Ranking

To make it really simple, let's categories the 8 monopoly sets into 'best', 'better', 'good', and 'bad', with 2 sets each:
...
However, by subscribing to these general concepts, I've had great success so far this holiday season and in general with Monopoly :wink:. Have fun, and good luck if you're playing any time over the holidays!
...
- Converting HTML <table> tag to CSV with: http://convertcsv.com/html-table-to-csv.htm
...
Jim Slater, the famous English bank businessman, [provides a breakdown of the expected returns of some of the monopolies (and independently matches what was found by me, I'll be proud to admit! :smile:) in the fourth episode of "The Mayfair Set" documentaries by Adam Curtis](https://www.youtube.com/watch?v=PdQ3ztGk0D4&t=57m38s), (though in the video he is referring to the English names of the properties, it's helpful that he still mentions the colors :joy:).
